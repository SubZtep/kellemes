...
class ChatCLI {
  ...
  private printWelcome(): void {
    ...
    console.log(`  ${colors.green}/rag${colors.reset}      - Toggle RAG mode (currently: ${this.options.useRAG ? 'ON' : 'OFF'})`);
    console.log(`  ${colors.green}/sources${colors.reset}  - Toggle source display (currently: ${this.options.showSources ? 'ON' : 'OFF'})`);
    console.log(`  ${colors.green}/topk N${colors.reset}   - Set number of context documents (currently: ${this.options.topK})`);
  ...
  private printStats(): void {
    ...
    console.log(`  RAG Ready: ${stats.isReady ? colors.green + 'Yes' + colors.reset : colors.red + 'No' + colors.reset}`);
  ...
  private printHelp(): void {
    ...
    console.log(`  ${colors.green}/rag${colors.reset}        - Toggle RAG mode (${this.options.useRAG ? 'currently ON' : 'currently OFF'})`);
    console.log(`  ${colors.green}/sources${colors.reset}    - Toggle source display (${this.options.showSources ? 'currently ON' : 'currently OFF'})`);
    console.log(`  ${colors.green}/topk <N>${colors.reset}   - Set number of documents to retrieve (current: ${this.options.topK})`);
    console.log(`  ${colors.green}/stats${colors.reset}      - Show system statistics`);
    console.log(`  ${colors.green}/clear${colors.reset}      - Clear the screen`);
    console.log(`  ${colors.green}/exit${colors.reset}       - Exit the chat`);
